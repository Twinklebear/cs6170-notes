...
making the analysis more challenging. Further, as these degeneracies capture important
structure about the protein shape which would be lost if perturbed they must be handled
...
\begin{figure}
	...
	three- and four-legged cases~\cite{WABER05}.}
\end{figure}
